	...
	public MyGUI (DataBase database) {
		...
		btnSearch.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				textPane.setText("Item Number | Item Title | Price | Auction Date | Seller | Timestamp\n");
				...
				try {
					...
					doc.insertString(doc.getLength(),data1,null);
						...
						if(textField_4.getText().equals("")){
							...
							//doc.insertString(0,"Item Number | Item Title | Price | Auction Date | Seller | Timestamp\n",null);
							doc.insertString(doc.getLength(), data2, null);
						}
						else{
							
						doc.insertString(doc.getLength(),database.itemInfoOnline(itemNum),null);
						}
					}
		...
		btnTransition.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String line;
					String result="";
					BufferedReader logbr = new BufferedReader(new FileReader(path+logFile));
